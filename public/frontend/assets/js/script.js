...
// var element = document.getElementsByClassName("cat_open");
var cat_open = $(".cat_open");

cat_open[0].addEventListener("click", function () {
    document.getElementById("mySidenav").classList.add('open-side');
});

var cat_close = $(".cat_close");
for (let i = 0; i < cat_close.length; i++) {
    cat_close[i].addEventListener("click", function () {
